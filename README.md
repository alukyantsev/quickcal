...
- Позволяет включить локальное расписание спринтов: задать точную дату и номер первого спринта, базовую длину 14 дней, отдельные длительности и паузы без спринта.
- Показывает компактную колонку номеров спринтов рядом с номерами недель, включая смену спринта внутри недели и паузы.
...
- Дополнительные настройки: номера недель, спринты, запуск при входе, погода и котировки.
