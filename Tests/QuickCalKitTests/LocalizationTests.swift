...
struct LocalizationTests {
    ...
    func russianPreferredLanguageUsesRussianStrings() {
        ...
        #expect(localization.format(.editSprintLengthFormat, 8) == "Длительность спринта 8")
        #expect(localization.string(.sprintHistoryWarning) == "Изменить прошедшее расписание?")
        #expect(localization.string(.editSprintLength) == "Изменить длительность")
    ...
    func englishPreferredLanguageUsesEnglishStringsAndKeepsRegion() {
        ...
        #expect(localization.format(.editSprintLengthFormat, 8) == "Sprint 8 length")
        #expect(localization.string(.sprintHistoryWarning) == "Change past sprint schedule?")
        #expect(localization.string(.editSprintLength) == "Edit length")
