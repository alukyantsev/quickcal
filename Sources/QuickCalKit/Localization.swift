...
public struct QuickCalLocalization: Sendable {
    public enum Key: String, CaseIterable, Sendable {
        ...
        case sprintColumn = "calendar.sprint_column"
        case sprintNumberFormat = "calendar.sprint_number_format"
        case currentSprint = "calendar.accessibility.current_sprint"
        case noSprint = "calendar.accessibility.no_sprint"
        case showWeekNumbers = "settings.show_week_numbers"
        case sprintSchedule = "settings.sprint_schedule"
        ...
        case sprintNumber = "settings.sprint_number"
        case editSprintLength = "settings.edit_sprint_length"
        case applySprintLength = "settings.apply_sprint_length"
        case sprintPause = "settings.sprint_pause"
        ...
        case sprintHistoryCancel = "settings.sprint_history_cancel"
